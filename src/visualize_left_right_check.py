...
def compute_grad_normals_region_bounded(levelset_t, X, Y, grid_scale, region_bounds):
    ...
    return (grad_vec, integrated_normal,
            ...
            intersection_span_bottom, intersection_length_bottom, intersection_span_left, intersection_length_left)


def plot_frame(ax, X, Y, levelset_t, edges, edges_info, region_bounds,
               grad_vec, integrated_normal, track_point, time_to_plot, 
               intersection_span_bottom, intersection_length_bottom, intersection_span_left, intersection_length_left, arrow_skip_rate=5):
    ...
    text_str = (f"Area Grad (L-R, T-B) (pink): ({grad_vec[0]:.6f}, {grad_vec[1]:.6f})\n"
...
def create_animation(h5_path, num_frames, time_range, region_bounds):
    ...
    frame_dir, filenames = "left_right_frames", []
    ...
    for i, time_idx in enumerate(tqdm(indices, desc="Processing Frames")):
        ...
        grad_vec, integrated_normal, edges, edges_info, intersection_span_bottom, intersection_length_bottom, intersection_span_left, intersection_length_left  = \
...
if __name__ == '__main__':
    ...
    COMPUTATION_REGION = (-0.25, 0.05, -0.2, 0.125)
